        ...
        style={{ background: "url('/images/header-bg.jpg') center/cover no-repeat" }}>
            <div className="container">
                <div className="text-center">
                    <h2 className="section-heading text-uppercase" style={{ color: "#ffc800" }}>Sell Your Product</h2>
                </div>
                    ...
                    <div className="col-lg-6">
                        <div className="card shadow p-4 bg-white">
                            <form action="/sell" method="POST">
                                ...
                                <button type="submit" className="btn btn-primary w-100">Post Product</button>
                            </form>
                        </div>
                    </div>
                </div>
